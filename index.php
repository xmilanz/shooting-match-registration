...
<div class="row">
    <div class="col-md-6">
        <div class="article">
            ...
            <dl class="row  text-start">
                ...
                <dt class="col-4 text-end text-start pe-0 <?= ($match_data['Zavod_registrace_pozastaveno'] == "") ? "d-none" : ""; ?>">Stav:</dt>
                <dd class="col-8 ps-2 text-danger <?= ($match_data['Zavod_registrace_pozastaveno'] == "") ? "d-none" : ""; ?>">Pozastavená registrace</dd>
                ...
                <dt class="col-12 text-center py-3">
                    <form method="get" action="<?= htmlspecialchars($match_data['Zavod_propozice'], ENT_QUOTES, 'UTF-8'); ?>"><button class="btn btn-outline-dark btn-sm" type="submit"><?= $download; ?>&nbsp;&nbsp;STÁHNOUT PROPOZICE</button></form>
                </dt>
            </dl>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="article pb-1 mb-4 <?= ($match_data['Zavod_zobrazovat_sponzory'] == "") ? "d-none" : ""; ?>">
            <div class="caption mb-2 p-2 ">
...
<div class="row my-3">
    ...
    <div class="col-md-6">
        <div class="article">
            ...
            <table class="<?= ($match_data['Zavod_registrace_pozastaveno'] == "on") ? "d-none" : ""; ?> table table-borderless m-2">
...
<div class="row my-3 <?= ($match_data['Payment_before'] == "") ? "d-none" : ""; ?>">
    <div class="col-md-6">
        <div class="article">
            <div class="caption mb-2 p-2">
