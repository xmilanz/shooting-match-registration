...
4. Doplňte vhodné názvy tabulek 
   ...
   ```
     - $table - tabulka závodníků - 
      ...
      - podle názvů vlastních závodů (URL) upravte podmínky pro názvy sdílených tabulek (často je vhodné, aby  eden typ závodu používat stejnou tabulku; jinak se pro každý závod vytvoří vlastní tabulky disciplín,  tartovného)
...
6. Otevřete match_URL
   ...
   - při přihlášení do administrace je vynucená změna hesla (! heslo musí splňovat určit požadavky !)
...
## Poděkování
Projekt vznikl jako praktický nástroj pro organizátory střeleckých závodů a vychází ze systému naprogramovaném Jiřím Šedinou (2010) a upraveným Janem Staňkem.
...
Vytvořte issue nebo mě kontaktujte přes GitHub nebo na adresu vývojáře uvedenou v config/data.php
