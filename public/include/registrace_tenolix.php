...
?>
    <div class="row">
        ...
        <div class="col-md-1 mt-5">
            <label class="form-check-label" for="Trenink<?= $katCode ?>">
    ...
    <div class="row mt-3">
        <div class="col-md-3">
            <label class="form-label mt-3">Zodpovědná osoba</label>
            <input class="form-control" type="text" name="ZodpovednaOsoba" id="ZodpovednaOsoba<?= $katCode ?> required"
        ...
        <div class="col-md-3">
            <label for="ObcanskyPrukaz" class="form-label mt-3">Číslo OP / EZP
                <a href="#" role="button" tabindex="0" id="userInfoBtn" data-bs-toggle="popover" data-bs-placement="top"
                    ...
                    data-bs-content="Nemá-li závodník dosud vydaný občanský průkaz<br>(nejčastěji kategorie Junior), napište číslo OP zodpovědné osoby.<br><br>U cizích státních příslušníků vyplňte číslo identifikačního <br>průkazu i v případě, že obsahuje mezery nebo písmena.">
    ...
    <div class="col-12 text-center mt-3">
        <button type="submit" name="registrovat_tenolix" class="btn btn-primary mb-2">Registrovat</button>
    </div>
<?php
