    ...
    <div class="row">
        <div class="col-md">
            <fieldset class="border p-3 mx-3 rounded">
                ...
                <div class="row">
                    <div class="col-md-8 <?= hidden($match_data['Zavod_obcansky_prukaz'] == 0); ?>">
                    ...
                    <div class="col-md-4 mt-5">
                        <label class="form-check-label d-block <?= hidden($match_data['Zavod_obcansky_prukaz'] == 0); ?>" for="ZbrojniOpravneni<?= $zkratka ?>">
                            <input class="me-1 form-check-input" type="checkbox" id="ZbrojniOpravneni<?= $zkratka ?>"
                                name="ZbrojniOpravneni"> Držitel ZO
                        </label>
                        <label class="form-check-label d-block" for="CMMS<?= $zkratka ?>">
                            <input class="me-1 form-check-input" type="checkbox" id="CMMS<?= $zkratka ?>"
                                name="CMMS"> Člen ČMMS
                        </label>
                    </div>
                </div>
        ...
        <div class="col-md">
            <fieldset class="border p-3 mx-3 rounded">
                <legend class="float-none w-auto px-2 h6">Bydliště</legend>
                <label for="Ulice<?= $zkratka ?>" class="form-label">Ulice a číslo</label>
                <input class="form-control" type="text" name="Ulice" id="Ulice<?= $zkratka ?>"
                    placeholder="Krumlovská 1400" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Krumlovská 1400'" required>
                <div class="invalid-feedback">Nevyplnili jste ulici a číslo</div>

                <label for="Mesto<?= $zkratka ?>" class="form-label mt-3">Město</label>
                <input class="form-control" type="text" name="Mesto" id="Mesto<?= $zkratka ?>"
                    placeholder="Prachatice" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = 'Prachatice'" required>
                <div class="invalid-feedback">Nevyplnili jste město</div>

                <label for="PSC<?= $zkratka ?>" class="form-label mt-3">PSČ</label>
                <input class="form-control" type="text" name="PSC" id="PSC<?= $zkratka ?>"
                    placeholder="38301" onfocus="this.placeholder = ''"
                    onblur="this.placeholder = '38301'" maxlength="5" required>
                <div class="invalid-feedback">Nevyplnili jste PSČ</div>
            </fieldset>
        </div>
    </div>
    ...
    <div class="row px-4 mt-3">
        <fieldset class="border p-3 mx-3 rounded">
            ...
            <div class="row">
                ...
                <div class="col-md-2 <?= hidden($match_data['Zavod_cislo_zbrane'] == 0); ?>">
                ...
                <div class="col-md-2 <?= hidden($match_data['Zavod_nazev_zbrane'] == 0); ?>">
                    <label for="NZ" class="form-label">Název zbraně</label>
