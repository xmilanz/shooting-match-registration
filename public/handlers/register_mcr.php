...
$stmt = $conn->prepare("
		INSERT INTO $table 
		(Prijmeni, Jmeno, ObcanskyPrukaz, ZbrojniOpravneni, Ulice, Mesto, PSC, CMMS, CisloZbrane, NazevZbrane, VarSym, Mail, Kategorie, DatReg, RegistraceIP, Disciplina, Staff, klic, CastkaZaplatit, Poznamka, Zavod)
		VALUES (?, ?, NULLIF(?,''), NULLIF(?,''), NULLIF(?,''), NULLIF(?,''), NULLIF(?,''), ?, NULLIF(?,''), NULLIF(?,''), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
	");
$stmt->bind_param(
    "sssssssissississsiiss",
    $prijmeni,
    $jmeno,
    $op,
    $zo,
