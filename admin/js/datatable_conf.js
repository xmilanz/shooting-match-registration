(function (w, $) {
    ...
    function getVisibleColumns(paymentBefore, registraceSmeny) {
        var columnConfig = {
            "1_0": [2, 5, 6, 10, 11, 12, 13, 14, 15, 16, 17, 18, 28], // předem
            "0_0": [2, 5, 6, 10, 11, 12, 13, 15, 16, 21],        // na místě
            "1_1": [1, 2, 5, 6, 10, 11, 12, 13, 15, 16, 17, 18, 28], // předem + směny
            "0_1": [1, 2, 5, 6, 10, 11, 12, 13, 15, 16, 21]       // na místě + směny
        };
