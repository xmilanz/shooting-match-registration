                ...
                <form class="row needs-validation" method="post" action="./save.php" novalidate>
                        ...
                        <fieldset class="border p-2 rounded">
                            ...
                            <div class="row p-1">
                                <div class="col-md-8">
                                    ...
                                    <input class="form-control" type="email" id="Mail" name="Mail" onfocus="this.placeholder = ''" onblur="this.placeholder='novak@mujemail.cz';replaceChars()" placeholder="novak@mujemail.cz" value="">
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="row m-1">
                        <fieldset class="border p-4 my-3 rounded">
                            ...
                            <div class="row">
                                <div class="col-md-6 <?= $zavodObcanskyPrukazClass ?>">
                                    ...
                                    <input class="form-control" type="text" name="ObcanskyPrukaz" id="ObcanskyPrukaz" placeholder="0123456789 / 0000000000" onfocus="this.placeholder = ''" onblur="this.placeholder = '0123456789 / 0000000000'">
                                </div>
                                <div class="col-md-6 mt-5 <?= $zavodObcanskyPrukazClass ?>">
                                    <label class="form-check-label" for="ZbrojniOpravneni">
                                        <input type="checkbox" class="form-check-input" id="ZbrojniOpravneni" name="ZbrojniOpravneni"> Držitel zbrojního oprávnění
                                    </label>
                                </div>
                                <div class="col-md-6">
